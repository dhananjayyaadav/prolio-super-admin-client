              ...
              >
                ...
                {question.type === "text" ? (
                  ...
                  <div className="bg-white shadow-3xl rounded-2xl pb-5 mb-10">
                    <div
                      className={`gap-2 p-10 mt-4 ${
                        question.description === "Variant"
                          ? ""
                          : "flex flex-row"
                      }`}
                    >
                      {question.cards.map((card, index) => (
                        <div key={index} className="flex flex-col pt-5">
                          ...
                          {card.type === "number" && (
                            <input
                              className="w-full px-2 h-10 border border-gray-300 mt-2 rounded-md focus:outline-none focus:border-blue-500"
                              type="number"
                          ...
                          {/* {card.description === "Quantity/Range" && (
                            <div className="flex flex-row">
                              <input
                                ...
                                placeholder="00"
                              />
                              <span className="text-center pt-3">To</span>
                              <input
                          ...
                          {card.type === "imageAttribute" && (
                            <>
                              {card.attributes.map((question, index) => (
                                <div
                                  key={index}
                                  className="flex items-center gap-2 w-full"
                                >
                                  {/* <input type="file" /> */}
                                  <div className="flex  justify-center items-center  text-center border-gray-500 rounded-2xl border-2 border-dashed  w-40 h-20  ">
                                    <h6 className="bg-white text-xs    text-center font-semibold">
                                      Add <br /> Image
                                    </h6>
                                  </div>
                                  <div className="flex flex-col  w-4/5 ">
                                    <span className="text-sm font-santoshi px-5">
                                      Attribute Name{" "}
                                    </span>
                                    <input
                                      className="w-4/5  h-9 text-sm mx-5 p-3  mt-2  focus:outline-none border  border-gray-300 rounded-sm focus:border-blue-500"
                                      type={question.name}
                                      placeholder={question.name}
                                    />
                                  </div>
                                  <div className="flex flex-col w-4/5">
                                    <span className="font-santoshi text-sm">
                                      Value
                                    </span>
                                    <input
                                      className=" w-4/5 h-9 text-sm p-3 mt-2 focus:outline-none border  border-gray-300 rounded-sm focus:border-blue-500"
                                      type={question.name}
                                      placeholder={question.name}
                                    />
                                  </div>
