      ...
      <div className="bg-white rounded-3xl w-full max-w-5xl max-h-[95vh] overflow-y-auto shadow-2xl animate-fade-in-down">
        ...
        <div className="sticky top-0 bg-gradient-to-r from-blue-800 to-blue-900 rounded-t-3xl px-6 py-5 flex justify-between items-center z-10">
          <div className="flex items-center space-x-4">
            <img
              src={company.companyDetails?.companyLogo?.url || "N/A"} // Default logo if companyLogo URL is not available
              alt="Company Logo"
              className="w-12 h-12 object-cover rounded-full" // You can adjust the size as needed
            />
            ...
            <div className="bg-blue-50 rounded-2xl p-6 shadow-sm">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <DetailRow
                  ...
                  label="Company About"
                  value={
                    [company.companyDetails?.companyInfo?.companyAbout]
                      .filter(Boolean)
                      .join(", ") || "Company About not provided"
                  }
                />
              </div>
            </div>
...
const AllCompanyList = () => {
  ...
  const navigateToCompanyLogs = (companyId, companyName) => {
    navigate(`/company/${companyId}/products`, { state: { companyName } });
  };
  ...
  return (
    <div className="bg-gradient-to-br from-blue-50 to-blue-100 hight-screen p-1">
